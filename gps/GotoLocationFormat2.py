...
redrouteinners = [ innersBaseDir + "innersxc.kml","red_inners_loc_names","red_inners_loc_coords"]
downhillinners = [ innersBaseDir + "inners_downhill.kml","inners_downhill_loc_names","inners_downhill_loc_coords"]
route = downhillinners
names = []
coords = []
